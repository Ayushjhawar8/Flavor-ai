...
export const festivalInfo = {
  All: {
    description:
      "Explore traditional dishes from various cultural festivals celebrated around the world",
  },
  Holi: {
    description:
      "Festival of colors celebrating spring with sweet treats and refreshing drinks",
  },
  Diwali: {
    description:
      "Festival of lights featuring rich sweets and savory snacks shared with loved ones",
  },
  Christmas: {
    description:
      "Celebrate the season with traditional baked goods and festive treats",
  },
  Eid: {
    description:
      "Mark the end of Ramadan with special dishes and sweet delicacies",
  },
};
