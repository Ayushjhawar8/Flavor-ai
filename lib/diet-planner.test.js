...
function validateInputParameters(params) {
  ...
  if (
    ...
    !validActivityLevels.includes(params.activityLevel)
  ) {
    errors.push(
      "activityLevel must be one of: " + validActivityLevels.join(", "),
    );
  }
  ...
  if (
    ...
    !validBloodPressure.includes(params.bloodPressure)
  ) {
    errors.push(
      "bloodPressure must be one of: " + validBloodPressure.join(", "),
    );
  }
