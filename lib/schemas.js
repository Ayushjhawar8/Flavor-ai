  ...
  recipe: z
    .object({
      ...
      area: z
        .string()
        .describe(
          "The geographical region or style of cuisine associated with the recipe.",
        ),
      category: z
        .string()
        .describe(
          "The category of the recipe, such as appetizer, main course, or dessert.",
        ),
      ingredients: z
      ...
      steps: z
        .array(z.string())
        .describe("A list of steps to prepare the recipe."),
...
const mealSchema = z
  .object({
    ...
    ingredients: z
      .array(ingredientSchema)
      .describe("List of ingredients for this meal."),
    instructions: z
      .array(z.string())
    ...
    healthBenefits: z
      .array(z.string())
      .optional()
      .describe("Health benefits specific to user goals and conditions."),
  })
...
export const dietPlanSchema = z.object({
  dietPlan: z
    .object({
      date: z
        .string()
        .describe("The date for this diet plan (YYYY-MM-DD format)."),
      ...
      totalCarbs: z
        .number()
        .describe("Total daily carbohydrate target in grams."),
      ...
      healthNotes: z
        ...
        .optional()
        .describe(
          "Important health considerations and tips based on user conditions.",
        ),
      hydrationGoal: z.string().describe("Daily water intake recommendation."),
      exerciseRecommendation: z
        .string()
        .describe("Exercise suggestion that complements the diet plan."),
    })
    .describe(
      "Complete daily diet plan tailored to user health profile and goals.",
    ),
});
