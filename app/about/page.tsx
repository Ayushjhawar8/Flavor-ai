  ...
  return (
    ...
    <div className={`flex flex-col min-h-screen ${currentTheme === 'dark' ? 'bg-base-100' : 'bg-white'}`}>
      ...
      <main className={`flex-grow pt-16 ${currentTheme === 'dark' ? 'text-base-content' : 'text-gray-900'}`}>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div className="order-2 lg:order-1">
                <h2 className={`text-3xl font-bold tracking-tight sm:text-4xl font-display ${currentTheme === 'dark' ? 'text-base-content' : 'text-gray-900'}`}>Our Journey</h2>
                <p className={`mt-4 text-lg font-bold ${currentTheme === 'dark' ? 'text-base-content/80' : 'text-gray-800'}`}>From Kitchen Dreams to AI-Powered Reality</p>
                <p className={`mt-4 ${currentTheme === 'dark' ? 'text-base-content/70' : 'text-gray-700'}`}>
        ...
        <section className="py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className={`text-3xl font-bold tracking-tight sm:text-4xl font-display ${currentTheme === 'dark' ? 'text-base-content' : 'text-gray-900'}`}>Our Philosophy</h2>
              <p className={`mx-auto mt-4 max-w-3xl text-lg ${currentTheme === 'dark' ? 'text-base-content/70' : 'text-gray-700'}`}>
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
                <div className={`rounded-xl border p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 ${currentTheme === 'dark' ? 'border-base-300 bg-base-200' : 'border-gray-200 bg-white'}`}>
                    <div className={`flex h-16 w-16 items-center justify-center rounded-xl mb-6 ${currentTheme === 'dark' ? 'bg-gradient-to-br from-amber-900/20 to-orange-900/20 text-amber-400' : 'bg-gradient-to-br from-amber-100 to-orange-100 text-amber-600'}`}>
                    ...
                    <h3 className={`text-xl font-bold font-display mb-3 ${currentTheme === 'dark' ? 'text-base-content' : 'text-gray-900'}`}>Innovation</h3>
                    <p className={`leading-relaxed ${currentTheme === 'dark' ? 'text-base-content/80' : 'text-gray-700'}`}>We constantly explore new frontiers in culinary AI, pushing the boundaries of what's possible in the kitchen.</p>
                </div>
                <div className={`rounded-xl border p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 ${currentTheme === 'dark' ? 'border-base-300 bg-base-200' : 'border-gray-200 bg-white'}`}>
                    <div className={`flex h-16 w-16 items-center justify-center rounded-xl mb-6 ${currentTheme === 'dark' ? 'bg-gradient-to-br from-blue-900/20 to-indigo-900/20 text-blue-400' : 'bg-gradient-to-br from-blue-100 to-indigo-100 text-blue-600'}`}>
                    ...
                    <h3 className={`text-xl font-bold font-display mb-3 ${currentTheme === 'dark' ? 'text-base-content' : 'text-gray-900'}`}>Community</h3>
                    <p className={`leading-relaxed ${currentTheme === 'dark' ? 'text-base-content/80' : 'text-gray-700'}`}>We foster a vibrant community of food enthusiasts, chefs, and developers, collaborating to shape the future of food.</p>
                </div>
                <div className={`rounded-xl border p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 ${currentTheme === 'dark' ? 'border-base-300 bg-base-200' : 'border-gray-200 bg-white'}`}>
                    <div className={`flex h-16 w-16 items-center justify-center rounded-xl mb-6 ${currentTheme === 'dark' ? 'bg-gradient-to-br from-green-900/20 to-emerald-900/20 text-green-400' : 'bg-gradient-to-br from-green-100 to-emerald-100 text-green-600'}`}>
                        <svg className="h-8 w-8" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24">
                    ...
                    <h3 className={`text-xl font-bold font-display mb-3 ${currentTheme === 'dark' ? 'text-base-content' : 'text-gray-900'}`}>Open Source</h3>
                    <p className={`leading-relaxed ${currentTheme === 'dark' ? 'text-base-content/80' : 'text-gray-700'}`}>We believe in transparency and collaboration, making our core technology open and accessible to all.</p>
                </div>
            </div>
          </div>
        </section>
        ...
        {/* CTA Section */}
        <section className={`py-16 sm:py-24 ${currentTheme === 'dark' ? 'bg-primary/10' : 'bg-primary/5'}`}>
