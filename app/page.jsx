      ...
      <div className="min-h-screen flex flex-col pt-[64px]"> {/* pt-[64px] to offset navbar height */}
        ...
        <footer className="w-full mt-10 p-6 md:p-10 min-h-[150px] bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-center gap-8 md:gap-0 text-center md:text-left">
            ...
            <div className="flex-1 flex flex-col items-center gap-4 md:gap-2">
              <a
                href="https://x.com/JhawarAj123"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-gray-200 transition text-base font-medium"
              >
                Ayush Jhawar
              </a>
              <div className="flex flex-col sm:flex-row gap-2 items-center justify-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="animate-bounce bg-gray-800 hover:bg-gray-900 text-white px-4 py-1 rounded-full text-sm font-semibold shadow-lg transition-all duration-300 hover:scale-105 inline-flex items-center gap-2 hover:shadow-xl"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
