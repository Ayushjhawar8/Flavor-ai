...
function Page() {
  ...
  // Nutrition moved to a dedicated page: /nutrition-ai
  ...
  // Nutrition fetching logic now lives in components/NutritionAI and app/nutrition-ai/page.jsx
  ...
  <BackButton />
        ...
        {/* Nutrition moved to a dedicated page: single centered button */}
        <div className="w-full mt-10 flex justify-center">
          <a href="/nutrition-ai" className="btn btn-primary">
            Open Nutrition AI Page
          </a>
        </div>
