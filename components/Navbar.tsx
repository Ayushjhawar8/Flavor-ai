...
export default function Navbar({
  ...
  return (
    <div className={`navbar fixed top-0 left-0 right-0 z-40 shadow-md flex flex-wrap items-center justify-between gap-y-2 px-4 py-2 md:py-3 transition-all duration-300 ${
      ...
      <div className="ml-auto md:ml-0 flex items-center gap-2 md:gap-4">
        {/* Community */}
        <Tooltip content="Community Recipes" position="bottom" delay={200}>
        ...
        {/* About Us */}
        <Tooltip content="Our Journey" position="bottom" delay={200}>
          <div className="rounded-full p-1 dark:bg-purple-800 transition-colors duration-300 hidden md:block">
            <Link
              href="/about"
              aria-label="About Us"
        ...
        {/* FAQ */}
        <Tooltip content="FAQ" position="bottom" delay={200}>
          <div className="rounded-full p-1 dark:bg-purple-800 transition-colors duration-300 hidden md:block">
            <Link
              href="/FAQ"
              aria-label="FAQ"
        ...
        <Tooltip content="Select Language" position="bottom" delay={200}>
          <GoogleTranslateWrapper />
        </Tooltip>
        <Tooltip content="Home" position="bottom" delay={200}>
          <div className="rounded-full p-1 dark:bg-purple-800 transition-colors duration-300 hidden md:block">
        ...
        <Tooltip content="Light/Dark Mode" position="bottom" delay={200}>
