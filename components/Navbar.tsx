    ...
    <div className="fixed inset-0 md:hidden z-[9999]">
      ...
      <div className="fixed top-0 right-0 h-full rounded-md w-64 bg-base-100 shadow-xl z-[10000]">
        <div className="flex flex-col p-4 space-y-4 h-full overflow-y-auto">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 p-2 rounded-lg border border-base-300 hover:bg-base-200 transition-colors"
          >
      ...
      <div className="ml-auto md:ml-0 flex items-center gap-2 md:gap-4">
        ...
        >
          ...
          >
            <Home
              size={16}
              className={`${currentTheme === "dark" ? "text-white" : "dark:text-white text-black"}`}
            />
          </Link>
        ...
        >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 28 28"
              className={`w-5 h-5 ${currentTheme === "dark" ? "text-white" : "dark:text-white text-black"}`}
              fill="currentColor"
            >
        ...
        >
          ...
          <GoogleTranslateWrapper className="w-8 h-8 flex items-center justify-center rounded-full backdrop-blur-sm bg-white/10 dark:bg-black/20 border border-white/20 shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg" />

          <span
            className={`pointer-events-none absolute top-full mt-2 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md px-2 py-1 text-xs font-medium bg-white/90 text-gray-900 border border-gray-300/60 shadow-md dark:bg-black/80 dark:text-white dark:border-white/10 transition-opacity duration-150 ${showTranslateTooltip ? "opacity-100" : "opacity-0"}`}
          >
            Translate
          </span>
        </div>
