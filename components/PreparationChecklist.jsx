    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-3">
          <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden"> {/* Changed to gray-200 for better contrast */}
            <div 
          ...
          {totalSteps > 0 && (
            <div className="text-center">
              <p className="text-sm font-medium text-base-content">
                ...
                {progressPercentage >= 50 && progressPercentage < 75 && "🌟 Almost there! Amazing!"}
                {progressPercentage >= 75 && progressPercentage < 100 && "💪 Final touches!"}
